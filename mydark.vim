...
" let g:airline#themes#mydark#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#mydark#palette.normal = {
...
" applied after g:airline#themes#mydark#palette.normal, hence why only certain keys are
" declared.
...
let g:airline#themes#mydark#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#mydark#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#mydark#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#mydark#palette.replace = copy(g:airline#themes#mydark#palette.insert)
let g:airline#themes#mydark#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#mydark#palette.replace_modified = g:airline#themes#mydark#palette.insert_modified
...
let g:airline#themes#mydark#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#mydark#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_inactive = [ '#a8a8a8' , '#1c1c1c' , 248 , 234 , '' ]
let s:airline_b_inactive = [ '#a8a8a8' , '#262626' , 248 , 235 , '' ]
let s:airline_c_inactive = [ '#a8a8a8' , '#303030' , 248 , 236 , '' ]
...
let g:airline#themes#mydark#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#mydark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
